...
import { GoGraphAlg } from './GoGraphAlg';

export default {
	title: 'GoGraphAlg',
	component: GoGraphAlg,
	decorators: [(Story) => <div>{Story()}</div>],
	argTypes: {
		turtleString: { control: { type: 'text' } },
		layoutName: { control: { type: 'inline-radio' } },
	},
} as ComponentMeta<typeof GoGraphAlg>;

const Template: ComponentStory<typeof GoGraphAlg> = ({ ...args }) => (
	<>
		<GoGraphAlg {...args} />
	</>
);
