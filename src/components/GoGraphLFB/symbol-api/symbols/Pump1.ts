...
export const Pump1: NodeSymbolTemplate = {
	id: 'Pump1',
	svg: svgString,
	height: 96,
	width: 85,
	connectors: [
		new NodeSymbolConnector('cp1', { x: 42.5, y: 42.7 }, PortBearing.E),
		new NodeSymbolConnector('cp2', { x: 42.5, y: 0.6 }, PortBearing.W),
	],
};
