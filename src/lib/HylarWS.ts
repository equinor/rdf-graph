...
export default class HylarWS extends Hylar {
		load(content: string, arg1: string, arg2: boolean) {
			throw new Error('Method not implemented.');
		}
		parseAndAddRule(transform: string | string[], name: string) {
			throw new Error('Method not implemented.');
		}
		query(arg0: string) {
			throw new Error('Method not implemented.');
    ...
    async parseAndAddRules(rawRules: any, entailment = this.entailment) {
        try {
